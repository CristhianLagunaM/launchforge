...
import { Category, Product, ProductUpsertPayload } from '../../../core/catalog/catalog.models';
...
export class ProductFormComponent implements OnChanges {
  ...
  @Output() saveProduct = new EventEmitter<ProductUpsertPayload>();
  ...
  submit(): void {
    ...
    this.saveProduct.emit(this.form.getRawValue());
  }
}
